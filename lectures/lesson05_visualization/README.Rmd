...
#' 3.
ggplot(data = dt)+
 geom_bar(aes(x = College,y = ..prop.., fill = Sex, group = 1))
```
...
```{r}
ggplot() +
  geom_bar(aes(x = College, fill = Sex)) +       #plot a count of students in each college
...
ggplot(data = dt) +
  ...
  scale_fill_manual(values  = c('#2D9FD9', 'red'))
