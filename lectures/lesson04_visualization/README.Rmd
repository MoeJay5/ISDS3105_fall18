...
ggplot() +
  geom_col(data =  freqCasualties, aes(x = class, y = n, fill = factor(gender)))
```
...
ggplot() +
  geom_line(data =  twitter_users, aes(x = Year, y = millions, color ='blue')) +
  geom_point(data =  twitter_users, aes(x = Year, y = millions, color ='red'))
```
...
ggplot() +
  geom_line(data =  twitter_users, aes(x = Year, y = millions, color ='twitter')) +
   geom_line(data =  sn_users, aes(x = year, y = facebook, color ='facebook'))
```
...
myBirthYear <- c(1997)
ggplot() + 
  geom_line(data = beerDt, aes(x = Year, y = GallonsCapita),color = 'blue') + 
  geom_point(data = myBirthYear, aes(x = Year, y = GallonsCapita, fill(year)))
```
